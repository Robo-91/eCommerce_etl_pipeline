...
def ingest_products():
    ...
    products_df = pd.read_csv(config['csv']['products'])
    ...
    truncate_query = 'TRUNCATE TABLE Products_Staging'
    ...
    # log results
    log_data = {'row_count': [len(products_df)], 'table_name': ['Products_Staging'], 'load_date': [date.today()]}
